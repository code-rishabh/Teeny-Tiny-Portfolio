...
const AboutBlock = () => {
  return (
    <Block className={`col-span-12 text-3xl leading-snug`}>
      <p>My passion is building cool stuff. </p>
      <span className="text-zinc-400">
        I build primarily with React, Tailwind CSS and Framer Motion. I love
        this stack for the frontend engineering. Alongside this I am also
        working in the Backend engineering for certain websites. This journey to
        full stack is awesome.
      </span>
    </Block>
  );
};
